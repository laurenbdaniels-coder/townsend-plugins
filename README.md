...
**TL;DR & So What:** A Claude Code / Cowork plugin marketplace with three plugins from Townsend AI Studio: **product-flow** (a ten-skill, stage-by-stage product management workflow — from "is this problem real?" to "did the launch work?" — with fill-in templates, evidence rules, and a built-in critique gate) and **pm-growth-coach** (a self-development coach that baselines your PM competencies and builds a deliberate-practice growth plan grounded in your real work artifacts), and **prompt-coach** (upleveled prompts with the right guardrails, plus a verification battery that audits an AI draft before it ships).
