...
**TL;DR & So What:** A Claude Code / Cowork plugin marketplace with two plugins from Townsend AI Studio: **product-flow** (a ten-skill, stage-by-stage product management workflow — from "is this problem real?" to "did the launch work?" — with fill-in templates, evidence rules, and a built-in critique gate) and **pm-growth-coach** (a self-development coach that baselines your PM competencies and builds a deliberate-practice growth plan grounded in your real work artifacts).

So what: install once, and Claude becomes both your product process and your PM development partner — in Claude Code, Cowork, or anywhere Claude plugins run.
