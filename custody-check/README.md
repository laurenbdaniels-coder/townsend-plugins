...
- If your app calls a model, the check asks five more questions after the eleven: how slow is too slow, where your prompts live, how you know a change made things better rather than different, what a user sees when the model is wrong, and whether you would notice the provider swapping the model under you. They are interview questions, not scanner ones, and they never change the door.
